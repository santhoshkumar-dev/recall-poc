...
pub const CATEGORY_PROMPTS: &[(&str, &[&str])] = &[
    ...
    ("bus_ticket", &[
        "a screenshot of a bus ticket",
        "a bus booking confirmation",
    ]),
    ("movie_ticket", &[
    ...
    ("chart", &[
        "a chart",
        "a graph or data visualization",
    ]),
    ("map", &[
        "a map",
        "a navigation screenshot",
        "a location map",
    ]),
    ("conversation", &[
